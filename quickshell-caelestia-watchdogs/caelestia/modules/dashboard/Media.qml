...
Item {
    ...
    ColumnLayout {
        ...
        StyledText {
            ...
            text: (Players.active?.trackTitle ?? "Kosong banget, gak ada media") || qsTr("Unknown title")
        ...
        StyledText {
            ...
            animate: true
            horizontalAlignment: Text.AlignHCenter
            text: (Players.active?.trackArtist ?? qsTr("Gas putar lagu biar muncul dimari!")) || "Kagak tau siapa"
