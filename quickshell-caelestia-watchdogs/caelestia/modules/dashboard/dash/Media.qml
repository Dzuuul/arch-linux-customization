...
Item {
    ...
    StyledText {
        ...
        text: (Players.active?.trackTitle ?? "Lagi sepi nih..") || qsTr("Unknown title")
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackAlbum ?? "Setel qiro'ah dong,") || qsTr("Unknown album")
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackArtist ?? "Biar tobat") || qsTr("Unknown artist")
